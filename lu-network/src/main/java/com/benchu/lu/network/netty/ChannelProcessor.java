...
//        this.matcher = TypeParameterMatcher.get(msgHandler.getSupportedMsgType());
    ...
    protected void channelRead0(final ChannelHandlerContext ctx, I msg) throws Exception {
        this.logger.warn("msg " + msg + " received from remoteAddress:" + ctx.channel().remoteAddress());
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        this.logger.warn("channelRead0,msg " + msg + " received from remoteAddress:" + ctx.channel().remoteAddress());
    }
